			...
			<Form ref="formValidate" :model="orderInfo" :label-width="80">
				...
				<Row>
					...
					<FormItem label="发货地址" prop="shippingAddress">
						<Input v-model="orderInfo.shippingAddress" placeholder="请输入发货地址"></Input>
					</FormItem>
					</Col>
					<Col span="8">
				...
				<Row>
					...
					<FormItem label="评价id" prop="eId">
						<Input v-model="orderInfo.eId" :maxlength=18 placeholder="请输入订单状态"></Input>
					</FormItem>
					</Col>
				</Row>
	...
	export default {
		...
		methods: {
			...
			show(data) {
				...
				this.orderInfo.shippingAddress = data.shippingAddress;
